...
test_redisson() {
    ...
    if ! start_app "structure-redisson-starter-example" 16008 "http://localhost:16008/"; then
        return 1
    fi
    
    print_success "✓ Redisson started successfully"
...
case "$1" in
    ...
    tenant)
        ...
        ;;
    *)
        echo "Usage: $0 {all|boot|log|minio|redis|redisson|restful-web|tenant}"
        echo ""
